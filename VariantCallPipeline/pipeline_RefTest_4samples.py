...
if True:
    outdir = "/research/btc_bioinformatic/operations/UaeRef/"
...
class Pipeline:
    ...
    ## Sorted_merged_dedup.bam ->  $GATKdir/<sample>_HaplotypeCaller.vcf
    ## Special fix for RefTest: skipping BQSR as this causes incompatibilities due to diff. coords
    def haplotypeCaller(self, jvmSpace=32, filetype='gvcf', compress=True):
        ...
        bamFile = self.findFiles(self.dirs['alignOutdir'], pattern="*_Merged_dedup.bam")[0]
